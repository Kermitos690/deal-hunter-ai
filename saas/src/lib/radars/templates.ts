...
export const RADAR_TEMPLATES: RadarTemplate[] = [
  ...
  ,{id:"swiss-watch-reference",title:"Montres suisses avec référence",description:"Montres identifiables destinées à une valorisation précise.",category:"Montres",brands:["Omega","TAG Heuer","Longines","Tissot"],include_keywords:["reference"],exclude_keywords:["replica","fake","aftermarket"],accepted_conditions:["A","B","C"],sale_types:["BUY_NOW","AUCTION"],min_roi_percent:18,min_profit:120}
  ,{id:"authenticated-luxury",title:"Luxe documenté, risque réduit",description:"Pièces avec facture, certificat ou authentification mentionnée.",category:"Sacs et accessoires",brands:["Louis Vuitton","Gucci","Prada","Hermès"],include_keywords:["authentic","certificate"],exclude_keywords:["replica","inspired","no return"],accepted_conditions:["NEW","A","B"],sale_types:["BUY_NOW"],min_roi_percent:15,min_profit:100}
];
