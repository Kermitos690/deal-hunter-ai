...
describe("Telegram radar sources", () => {
  it("accepte uniquement les sources opérationnelles", () => {
    ...
    expect(parseRadarSources("tout")).toEqual(["ebay","ricardo","anibis","komehyo","email-alerts","rss"]);
    expect(parseRadarSources("toutes sauf mock")).toEqual(["ebay","ricardo","anibis","komehyo","email-alerts","rss"]);
