      ...
      <section className="mx-auto grid min-h-[70vh] max-w-6xl items-center gap-12 px-6 py-16 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-6 max-w-xl text-lg text-slate-300">
            Crée tes radars luxe, montres vintage et lots B2B. Deal Hunter calcule la marge,
            signale les risques et t’alerte uniquement quand tes critères sont respectés.
          </p>
